        ...
        <form method="POST">
            ...
            <%
                ...
                if(request.getParameter("examselect")!=null){
                    ...
                    rs=con.SelectData("select * from exam_master where examID in (select distinct examID from question_master) and subjectID="+request.getParameter("subject1")+" and batch="+request.getParameter("batch1")+";");
                    ...
                    out.println("</select><br/><br/><button name='addMarks' value='addMarks' onclick=\"Upload()\">Add Marks</button></form><br/><br/>");
                }  
                ...
                if(s.equals(rs4.getString("typeDescription"))){
                    out.println("<br/><input type=\"file\" id=\"fileUpload\" /><br/><input type=\"button\" id=\"upload\" value=\"Import\" onclick=\"UploadESE()\" /><br/>");
                    out.println("<br/><b>Instructions for IMPORT:</b><br/><li>Upload .csv File Only</li><li>Enrollment should be same as mentioned below.</li><li>Column Order Should be same as Below</li><li>First will be considered as a HEADING</li><li>Please <b>VERIFY</b> the Data before SUBMIT</li><br/>");
                    out.println("<div id='wrapper'></div>");
                    ...
                    while(x2<=nOfStudents && rs3.next()){
                        out.println("<tr><td><input type='text' id='enroll"+x2+"' name='enroll"+x2+"' value='"+rs3.getString("enrollmentno")+"' disabled></td>");
                ...
                out.println("<br/><input type=\"file\" id=\"fileUpload\" /><br/><input type=\"button\" id=\"upload\" value=\"Import\" onclick=\"Upload()\" /><br/>");
                out.println("<br/><b>Instructions for Import:</b><br/><li>Upload .csv File Only</li><li>Enrollment should be same as mentioned below.</li><li>Column Order Should be same as Below</li><li>First will be considered as a HEADING</li><li>Please <b>VERIFY</b> the Data before SUBMIT</li><br/>");
                out.println("<div id='wrapper'></div>");
                out.println("<br/>ExamID: <input type='number' name='examid2' value='"+request.getParameter("examid")+"' disabled/>");
                ...
                while(x2<=nOfStudents && rs3.next()){
                    out.println("<tr><td><input type='text' id='enroll"+x2+"' name='enroll"+x2+"' value='"+rs3.getString("enrollmentno")+"' disabled></td>");
                    while(x<=nOfQue){
                        out.println("<td><input type='text' id='"+x2+"que"+x+"' name='"+x2+"que"+x+"'></td>");
                        x++;
                    }
                    x=1;
                    out.println("</tr>");
