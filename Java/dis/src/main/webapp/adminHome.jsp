...
<div class="container" style="width: 90%; margin-bottom: 100px;">
	...
	rsCount=con.SelectData("select ( select count(*) from admin_master where isApproved=0) + ( select count(*) from faculty_master where isApproved=0 and facultyDepartment="+userDept+") as cnt;");
	rsCount.next();
	%>
